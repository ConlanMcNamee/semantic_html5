...
React.render(React.createElement(App, {appName: "Reactify semantic HTML5"}), document.body);

},{"./components/body.jsx":3,"react":161}],2:[function(require,module,exports){
var React = require('react');
	...
	render: function() {
		return (
			React.createElement("aside", null, 
				...
				React.createElement("button", {name: "submitLink"}), 
				React.createElement("button", {name: "submitTextPost"}), 
				React.createElement("button", {name: "CreateSubreddit"}), 
				React.createElement("div", {id: "redditGoldGoal"}), 
				React.createElement("section", {id: "recentlyViewed"})
			)
		)
	}
});
	...
	render: function() {
		return (
			React.createElement("main", null, 
				...
				React.createElement("article", {class: "Post"}, 
					React.createElement("div", {class: "upVoteDownVote"}
						
					), 
					React.createElement("div", {class: "redditPost"}, 
						React.createElement("h1", {class: "redditPostTitle"}, "This is the top post"), 
						React.createElement("footer", {class: "footerLinks"})
					)
				), 
				React.createElement("article", {class: "Post"}, 
					React.createElement("div", {class: "upVoteDownVote"}
					...
					React.createElement("div", {class: "redditPost"}, 
						React.createElement("h1", {class: "redditPostTitle"}, "This is the second to top post"), 
						React.createElement("footer", {class: "footerLinks"})
					)
				), 
				React.createElement("footer", {id: "next"}, 
					React.createElement("button", {id: "nextButton"}, "next ")
				), 
				React.createElement(Aside, null), 
...
},{"./aside.jsx":2,"./footer.jsx":4,"./header.jsx":5,"react":161}],4:[function(require,module,exports){
var React = require('react');
	...
	render: function() {
		return (
			React.createElement("footer", null, 
				...
				React.createElement("section", {id: "help"}), 
				React.createElement("section", {id: "appsTools"}), 
				React.createElement("section", {id: "heart"}), 
		...
		return (
			React.createElement("header", null, 
				React.createElement("nav", null, 
					React.createElement("a", {href: "reddit front"}, "Front"), 
					React.createElement("a", {href: "reddit all"}, "All"), 
					React.createElement("a", {href: "reddit random"}, "Random")
				)
			)
		)
	}
